          ...
          return (
            <motion.button
              ...
              className={`
                ...
                ${resource ? `${config.color} ${config.hoverColor} cursor-pointer shadow-sm hover:shadow-md` : 'bg-gray-50 text-gray-400 cursor-not-allowed border-gray-200'}
              `}
            >
              <div className="flex items-start gap-2">
                <Icon size={16} className={`flex-shrink-0 mt-0.5 ${resource ? '' : 'text-gray-400'}`} />
